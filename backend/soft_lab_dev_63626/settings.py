"""
Django settings for soft_lab_dev_63626 project.
...
ROOT_URLCONF = 'soft_lab_dev_63626.urls'
...
WSGI_APPLICATION = 'soft_lab_dev_63626.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_lab_dev_63626 API",
    "DESCRIPTION": "API documentation for soft_lab_dev_63626 App",
    "VERSION": "v1",
}
